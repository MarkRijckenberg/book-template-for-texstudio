...
Performing backup of this document to a safe location:

<<engine='bash'>>=
cp  ~/book-template-for-texstudio/edx-mitx-15.071x-analytics-edge-template.Rnw  ~/edx-mitx-15.071x-analytics-edge-template.Rnw
@
