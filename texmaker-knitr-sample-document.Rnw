...
%% texmaker+knitr install and configuration procedure:
%%
%% cd; rm knitr_*.tar.gz
%% git clone https://github.com/yihui/knitr.git
%% sudo apt-get update
%% sudo apt-get install texinfo texmaker
...
%% texmaker 4.1.1 created this file.  For more info, see http://www.xm1math.net/texmaker/
...
<<plot-girls-vs-year-line, eval=TRUE>>=
...
<<plot-help, eval=TRUE, tidy = FALSE>>=
?plot
@
...
<<calc-prop-boys-to-girls-numbers, eval=TRUE>>=
5218 / 4683
@

or we can act on the complete vectors with the expression

<<calc-prop-boys-to-girls-vars, eval=TRUE>>=
arbuthnot$boys / arbuthnot$girls
@

The proportion of newborns that are boys

<<calc-prop-boys-numbers, eval=TRUE>>=
5218 / (5218 + 4683)
@

or this may also be computed for all years simultaneously:

<<calc-prop-boys-vars, eval=TRUE>>=
...
<<boys-more-than-girls, eval=TRUE>>=
arbuthnot$boys > arbuthnot$girls
@
