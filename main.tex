...
%                texlive-latex-extra, biblatex, TeXstudio 2.6.6 or newer
% Run following Terminal command to download and install all the prerequisites in Lubuntu 13.10 or newer:
% sudo apt-get update && sudo apt-get install texlive-latex-extra texlive-bibtex-extra latex-xcolor biber texlive-fonts-recommended
...
% TeXstudio 2.6.6 (or newer) binary works a lot better and is more stable than texmaker in Ubuntu 13.04
