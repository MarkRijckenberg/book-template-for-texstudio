...
% 2) press F12 to generate index file and create index chapeter
% 3) press F1 twice to build and view output PDF
...
% Use \cite[page 23]{kennedy1998cationic}  for example when citing bibliography references contained in the 
