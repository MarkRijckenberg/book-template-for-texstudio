...
% Prerequisites: Lubuntu 13.10 or newer, texlive-bibtex-extra, latex-xcolor, biber, texlive-fonts-recommended, 
%                texlive-binaries, texlive-latex-base, texlive-publishers, 
%                texlive-latex-extra, TeXstudio 2.6.6 or newer, biblatex
% Run following Terminal command to download and install all the prerequisites in Lubuntu 13.10 or newer:
% sudo apt-get update && sudo apt-get install biber texlive-fonts-recommended
